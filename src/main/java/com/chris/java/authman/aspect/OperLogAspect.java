...
package com.chris.java.authman.aspect;
...
import com.chris.java.authman.common.IpUtil;
...
import com.chris.java.authman.util.DateUtil;
...
public class OperLogAspect {
     ...
     * 操作日志切入点
     */
    @Pointcut("@annotation(com.chris.java.authman.annotation.OperLog)")
